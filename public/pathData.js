globalObject.loadPathData(JSON.stringify({
    ...
    path:[
        ...
        },
        {
            ...
            title: 'Tick Yes to join Velocity Frequent Flyer for free and you could WIN 1 of 20 prizes of $2,000 worth of flights with Virgin Australia to take you on your next adventure.<br>By ticking Yes, I confirm that I have read and agree to the Velocity membership T&Cs, the Velocity Privacy Statement, Privacy Policy, and the competition T&Cs for the above draw.',
        ...
        {
            type: 'endCard',
            title: 'Congratulations {firstName}! You’re in the draw to Win a $10,000 New York Shopping Spree.<br><br>You’ll begin receiving the latest Surveys & Competitions shortly, catered to your interests.<br><br>You will be redirected to one of our partners shortly.',
